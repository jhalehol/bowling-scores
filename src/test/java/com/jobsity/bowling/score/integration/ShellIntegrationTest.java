...
public class ShellIntegrationTest {
    ...
    public void givenValidSourceWhenScoreThenShouldReturnProperReport() {
        ...
        errorCollector.checkThat(shellResult.contains("X\t7\t/\t9\t0\t\tX\t0\t8\t8\t/\tF\t6\t\tX\t\tX\tX\t8\t1"),
                equalTo(true));
        ...
        errorCollector.checkThat(shellResult.contains("3\t/\t6\t3\t\tX\t8\t1\t\tX\t\tX\t9\t0\t7\t/\t4\t4\tX\t9\t0"),
                equalTo(true));
    ...
    private void assertPerfectResult(final String shellResult) {
        errorCollector.checkThat(shellResult.contains("X\t\tX\t\tX\t\tX\t\tX\t\tX\t\tX\t\tX\t\tX\tX\tX\tX"),
                equalTo(true));
